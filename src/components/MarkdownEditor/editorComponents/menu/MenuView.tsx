...
import { MenuControls, MenuProvider, menu, menuConfig } from './menu'
...
import { template } from '../customNode/Diagram/utils'
        ...
        <Space>
          {!loading &&
            getEditor()
              ...
              .controls.map((key, index) => <Fragment key={index}>{controlBtns[key]}</Fragment>)}
        </Space>
      </div>
    </div>
  )
