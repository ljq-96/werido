...
export const CodeFence: FC<{ children: ReactNode }> = ({ children }) => {
  ...
  console.log(node, ctx, view, getPos)

  const [input, setInput] = useState('')

  return (
    <div className='code-fenceqqqqq' style={{ border: '1px solid red', padding: 10 }}>
      <div className='control' style={{ marginBottom: 10, display: 'flex', justifyContent: 'space-between' }}>
        <span className='filename' style={{ border: '1px solid red', padding: 10 }}>
