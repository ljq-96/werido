...
export class DocIndexService {
  ...
  public async getDocIndex({ user, type }: { user: string; type: DocIndexType }): Promise<Doc> {
  ...
  public async updateOne({ user, type }: { user: string; type: DocIndexType }, content: object) {
